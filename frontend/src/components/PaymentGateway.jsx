...
const PaymentGateway = ({ appointment, onClose }) => {
  ...
  const handlePayment = async () => {
    try {
      ...
      if (!appointment || !appointment.fees || appointment.fees <= 0) {
        ...
        <form className="form">
          ...
          {appointment && (
            <div className="payment-details">
              ...
              <p className="text-sm text-gray-600 mb-1">Doctor: {appointment.name}</p>
              <p className="text-sm text-gray-600 mb-1">Speciality: {appointment.speciality}</p>
              <p className="text-lg font-bold text-green-600">Amount: ₹{appointment.fees}</p>
            </div>
          )}
          <div className="credit-card-info--form">
            ...
            <div className="input_container">
              <label htmlFor="expiry_cvv" className="input_label">Expiry Date / CVV</label>
              <div className="split">
                <input 
                  id="expiry" 
                  className="input_field" 
          ...
          <button className="purchase--btn" onClick={handlePayment}>Pay ₹{appointment?.fees || 0}</button>
        </form>
      </div>
    </StyledWrapper>
  );
